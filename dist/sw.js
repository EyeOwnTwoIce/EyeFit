...
const CACHE = "eyefit-vmsgk53bq";
const CORE_ASSETS = ["./","./index.html","./styles.ab80ccca.css","./app.34d3b03e.js","./manifest.json","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./exercise-meta.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png"];
