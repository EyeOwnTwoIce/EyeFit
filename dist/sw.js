...
const CACHE = "eyefit-vmsh606x2";
const CORE_ASSETS = ["./","./index.html","./styles.2d681062.css","./app.30c6e33a.js","./manifest.json","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./exercise-meta.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png"];
