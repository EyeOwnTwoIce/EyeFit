...
/* Bridge temporal: estado/función que aún viven en app.js y que los módulos necesitan.
   - editingHistRecord/openEditHistSession → views-historial (#21)
   Se eliminan de aquí cuando se extraiga ese módulo. */
