...
const CACHE = "eyefit-vmsgqj30k";
const CORE_ASSETS = ["./","./index.html","./styles.3bbf16e0.css","./app.73eef10d.js","./manifest.json","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./exercise-meta.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png"];
