...
- Name: eyefit.spec.js >> marcar serie completada inicia cronómetro de descanso
- Location: tests/eyefit.spec.js:55:1
...
Locator: locator('.rest-banner')
Expected pattern: /show/
Received string:  "rest-banner "
Timeout: 5000ms

Call log:
  - Expect "toHaveClass" with timeout 5000ms
  - waiting for locator('.rest-banner')
    14 × locator resolved to <div id="restBanner" class="rest-banner ">…</div>
       - unexpected value "rest-banner "
...
- main:
  ...
  - button "⏸ Pausar"
  - button "↺ Reiniciar"
  - text: 1. Press banca plano con barra 1 / 6 ⚖️ 40 kg inicio ⏱ 3min descanso ✓ 0/6 ejercicios 1
  - button "−"
  - text: 40 kg
  - button "+"
  - button "−"
  ...
  - button "+"
  - button "✓" [disabled]
  - text: Siguiente ejercicio 2. Press inclinado con mancuernas 3 series · 10 reps · 18 kg
