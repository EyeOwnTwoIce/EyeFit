...
const CACHE = "eyefit-vmsh6n97q";
const CORE_ASSETS = ["./","./index.html","./styles.ecb09469.css","./app.30c6e33a.js","./manifest.json","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./exercise-meta.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png"];
