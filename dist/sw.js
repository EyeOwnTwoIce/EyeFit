...
const CACHE = "eyefit-vmsekwtkr";
const CORE_ASSETS = ["./","./index.html","./styles.68daba14.css","./app.687887b7.js","./manifest.json","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png"];
