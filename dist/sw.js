...
const CACHE = "eyefit-vmsn3uj3l";
const CORE_ASSETS = ["./","./index.html","./styles.a7cb4cb1.css","./app.32ab7d6f.js","./manifest.json","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./exercise-meta.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png"];
