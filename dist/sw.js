...
const CACHE = "eyefit-vmsx0oi2o"; // build inyecta CACHE versionado (tools/build.js)
const CORE_ASSETS = ["./","./index.html","./styles.a7cb4cb1.css","./app.9ec1f6bd.js","./manifest.json","./constants.js","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./exercise-meta.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png","./modules/auth.js","./modules/config.js","./modules/dataset.js","./modules/persistence.js","./modules/push.js","./modules/rest-timer.js","./modules/session.js","./modules/supabase.js","./modules/ui.js","./modules/views-rutina.js","./modules/xlsx-io.js"]; // build inyecta los assets hasheados
...
self.addEventListener('message', event => {
  // Seguridad (CWE-20/940): verificar que el mensaje proviene de nuestra propia
  // app (mismo origen), no de una ventana externa.
