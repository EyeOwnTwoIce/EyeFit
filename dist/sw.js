...
const CACHE = "eyefit-vmsgl37zy";
const CORE_ASSETS = ["./","./index.html","./styles.9da14b7d.css","./app.bc80f993.js","./manifest.json","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./exercise-meta.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png"];
