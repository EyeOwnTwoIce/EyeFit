...
const CACHE = "eyefit-vmsgjzlo5";
const CORE_ASSETS = ["./","./index.html","./styles.8388b738.css","./app.960943f6.js","./manifest.json","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./exercise-meta.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png"];
