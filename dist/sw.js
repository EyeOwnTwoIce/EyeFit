...
const CACHE = "eyefit-vmsfskypz";
const CORE_ASSETS = ["./","./index.html","./styles.0d79bbb4.css","./app.26cdeb0a.js","./manifest.json","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png"];
