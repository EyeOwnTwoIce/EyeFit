...
const CACHE = "eyefit-vmsfx8y8a";
const CORE_ASSETS = ["./","./index.html","./styles.bb221c53.css","./app.a3cd6828.js","./manifest.json","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png"];
