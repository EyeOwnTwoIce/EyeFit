...
const CACHE = "eyefit-vmsnlec7k"; // build inyecta CACHE versionado (tools/build.js)
const CORE_ASSETS = ["./","./index.html","./styles.a7cb4cb1.css","./app.32ab7d6f.js","./manifest.json","./constants.js","./utils.js","./db.js","./supabase.js","./rutina.xlsx","./slim-dataset.json","./exercise-meta.json","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png"]; // build inyecta los assets hasheados
